...
export function Sidebar({ activeTool, onToolChange, onAddObject }: SidebarProps) {
  ...
  return (
    <div className="w-full h-full bg-white border-r border-gray-200 flex flex-col overflow-y-auto">
      <div className="p-4">
        <h2 className="text-gray-900 text-sm uppercase tracking-wide mb-3">Tools</h2>
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            onClick={() => {
              onToolChange('shape');
              setExpandedSection(expandedSection === 'shapes' ? null : 'shapes');
            }}
            className={`p-3 rounded flex flex-col items-center gap-2 transition-colors ${
              activeTool === 'shape' 
                ? 'bg-[#1C75BC] text-white' 
